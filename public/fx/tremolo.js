...
const fx = {
    ...
    snippet: {
        'Module': 'EffectTremoloPan',
        'Bypass': 'Off',
        'Attack Curve': 0.667 // TremoloPan (Pan effect) has an Attack Curve of 0.666 we use this to tell them apart since they are the same efffect module under the hood
    },
    sliceSnippet: {
        "Module": "EffectTremoloPan",
        'Bypass': 'Off',
